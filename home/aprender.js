...
const APRENDER_LESSONS = [
  ...
  },
  {
    ...
    desc:       { pt: 'Os 30 sinais mais comuns que representam duas consoantes. A base para ler palavras reais.', en: 'The 30 most common signs representing two consonants. The foundation for reading real words.' },
    dur:        { pt: '~25 min', en: '~25 min' },
    type:       { pt: '30 sinais', en: '30 signs' },
  ...
  },
  {
    ...
    href:       'aprender/04-palavras.html',
    badge:      { pt: 'Novo', en: 'New' },
    badgeClass: 'badge-new',
  },
  {
    ...
    href:       'aprender/05-cartuchos.html',
