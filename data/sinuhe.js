const I18N = {
  pt: {
    ...
    'intro-desc':      'Você vai ler a história em 8 partes baseadas principalmente no <span class="gloss" data-gloss="papiro-berlin">Papiro Berlin 3022</span>. No fim de cada parte, um desafio sobre a trama ou a cultura egípcia. Acerte de primeira para coletar tesouros da terra de <span class="gloss" data-gloss="araru">Araru</span>!',
    'correct':         'CORRETO',
    'warning':         'CUIDADO!',
  ...
  en: {
    ...
    'intro-desc':      'Read the tale in 8 parts based mainly on the <span class="gloss" data-gloss="papiro-berlin">Berlin Papyrus 3022</span>. After each part, take a challenge on the plot or Egyptian culture. Answer on the first try to collect treasures from the land of <span class="gloss" data-gloss="araru">Araru</span>!',
    'correct':         'CORRECT',
    'warning':         'WARNING!',
...
const GLOSSARY = [
  ...
  },
  {
    ...
    tagPt: 'Faraó', tagEn: 'Pharaoh',
    defPt: 'Filho e sucessor de <span class="gloss" data-gloss="amenemhat">Amenemhat I</span>, cujo nome de trono era <i>Kheperkare</i> ("a manifestação da alma de Rá"). Governou o Egito por cerca de 45 anos. No texto, é ele quem envia a carta chamando Sinué de volta ao exílio e ordena a construção de uma pirâmide para o cortesão. É descrito por Sinué com elogios hiperbólicos, um recurso literário típico do Reino Médio.',
...
const CHAPTERS = [
  {
    ...
    storyPt: `<p class="dropcap">Era o trigésimo ano do reinado de <span class="gloss" data-gloss="amenemhat">Amenemhat</span>. No terceiro mês da estação de inundação, no sétimo dia, o deus entrou em seu horizonte. O faraó ascendeu ao céu e se uniu ao sol. Seu corpo divino fundiu-se àquele que o criara.</p><p>A residência real estava em silêncio. Os corações jaziam em luto, as grandes portas duplas estavam fechadas e os cortesãos gemiam. <span class="gloss" data-gloss="sesostris">Sesostris</span> havia sido enviado com um grande exército para subjugar as terras dos líbios. Mensageiros secretos foram despachados à fronteira ocidental para que o príncipe soubesse do que havia acontecido dentro do palácio. Eles o encontraram no caminho, ao cair da noite. Ele não hesitou um instante, o falcão voou com seus seguidores, sem informar seu exército.</p><p>Eu, <span class="gloss" data-gloss="sa-nht">Sinué</span>, era servo do harém real, seguidor do soberano. Estava presente quando os mensageiros chegaram. Ouvi a voz deles, e enquanto falavam, eu estava perto demais de um complô. Meu coração se turbou. Meus braços se abriram. O tremor caiu sobre todos os meus membros. Saltei para longe, procurando um esconderijo.</p>`,
    storyEn: `<p class="dropcap">It was the thirtieth year of <span class="gloss" data-gloss="amenemhat">Amenemhat</span>'s reign. On the seventh day of the third month of the inundation season, the god entered his horizon. The pharaoh ascended to heaven and was united with the sun. His divine body merged with him who had created him.</p><p>The royal residence was in silence. Hearts lay in mourning, the great double gate was sealed, and courtiers were wailing. <span class="gloss" data-gloss="sesostris">Sesostris</span> had been sent with a great army to strike down the lands of the Libyans. Secret messengers were dispatched to the western border to inform the prince of what had happened inside the palace. They found him on the road at nightfall. He did not hesitate for an instant, the falcon flew off with his followers, without informing his army.</p><p>I, <span class="gloss" data-gloss="sa-nht">Sinuhe</span>, was a servant of the royal harem, a follower of the sovereign. I was present when the messengers arrived. I heard their voices, and as they spoke, I was close to a conspiracy. My heart grew confused. My arms dropped wide. Trembling fell over all my limbs. I leapt away, searching for a hiding place.</p>`,
    question: {
  ...
  },
  {
    ...
    storyPt: `<p class="dropcap">Coloquei-me entre dois arbustos para dar passagem aos que caminhavam pela estrada. Segui para o sul, não tinha intenção de alcançar a residência real, pois esperava conflito. Atravessei a região de Maati e cheguei à Ilha de Snofru. Parti de madrugada, cruzei o rio num barco sem leme, empurrado pelo vento do oeste.</p><p>Avancei para o norte, até avistar os <span class="gloss" data-gloss="muros-do-soberano">Muros do Soberano</span>. Agachei-me entre os arbustos, com medo de ser visto pelos guardas. Atravessei no escuro, cheguei a Peten, depois à ilha de Kemur. A sede caiu sobre mim como fogo. Minha garganta estava ressecada. "Este é o sabor da morte", pensei.</p><p>Então meu coração se ergueu: ouvi o mugido distante de gado. Vi <span class="gloss" data-gloss="retjenu">beduínos</span> ao longe. O líder deles, que havia estado no Egito, me reconheceu. Deu-me água e ferveu leite para mim. Fui com ele até seu clã, e o que fizeram por mim foi bom. Terra passou a me dar a outra terra.</p>`,
    storyEn: `<p class="dropcap">I placed myself between two bushes to clear the road for those passing by. I went southward, I had no intention of reaching the royal residence, for I expected trouble. I crossed the region of Maati and reached the Island of Snofru. I departed at dawn, crossed the river in a boat without a rudder, carried by the west wind.</p><p>I pushed northward until I spotted the <span class="gloss" data-gloss="muros-do-soberano">Walls of the Ruler</span>. I crouched among the bushes, fearing the guards would see me. I crossed in darkness, reached Peten, then the island of Kemur. Thirst overtook me like fire. My throat was parched. "This is the taste of death," I thought.</p><p>Then my heart lifted: I heard the distant lowing of cattle. I spotted <span class="gloss" data-gloss="retjenu">bedouin</span> in the distance. Their leader, who had been in Egypt, recognized me. He gave me water and boiled milk for me. I went with him to his clan, and what they did for me was good. Land passed me to land.</p>`,
    question: {
  ...
  },
  {
    ...
    notePt: '<span class="gloss" data-gloss="amunenshi">Amunenshi</span> pergunta a Sinué o que aconteceu no Egito, não porque não sabia, mas como protocolo diplomático. A resposta de Sinué é deliberadamente vaga sobre as circunstâncias da morte do faraó, revelando a delicadeza política do momento. Sinué omite a causa real de sua fuga: medo, não traição.',
    noteEn: '<span class="gloss" data-gloss="amunenshi">Amunenshi</span> asks Sinuhe what happened in Egypt, not because he didn\'t know, but as diplomatic protocol. Sinuhe\'s answer is deliberately vague about the circumstances of the pharaoh\'s death, revealing the political delicacy of the moment. Sinuhe conceals the real cause of his flight: fear, not treason.',
    storyPt: `<p class="dropcap">Da terra de Byblos parti rumo a Qedem. Passei lá um ano e meio. Foi então que <span class="gloss" data-gloss="amunenshi">Amunenshi</span>, soberano do Alto <span class="gloss" data-gloss="retjenu">Retjenu</span>, mandou buscar-me. "Você ficará bem comigo", disse ele, "pois aqui ouvirá a língua do Egito."</p><p>Ele me perguntou o que havia acontecido na residência. Contei-lhe que o rei havia partido, mas sobre os pormenores, fui vago, fabricando uma resposta cautelosa: dissera que havia retornado de uma expedição à Líbia, que a notícia me foi trazida e meu coração fraquejou. Não sabia o que me trouxera àquela terra, era como o plano de um deus, ou como um sonho.</p><p>Amunenshi ficou satisfeito. Deu-me sua filha mais velha em casamento. Deixou-me escolher de suas terras o que havia de melhor na fronteira com outra região. Era uma terra chamada <span class="gloss" data-gloss="araru">Araru</span>.</p>`,
    storyEn: `<p class="dropcap">From the land of Byblos I departed toward Qedem. I spent a year and a half there. It was then that <span class="gloss" data-gloss="amunenshi">Amunenshi</span>, ruler of Upper <span class="gloss" data-gloss="retjenu">Retjenu</span>, came to fetch me. "You will be well with me," he said, "for here you will hear the language of Egypt."</p><p>He asked me what had happened at the residence. I told him that the king had departed, but about the details I was vague, fabricating a careful answer: I said I had returned from an expedition to Libya, that the news was brought to me, and my heart grew weak. I did not know what had brought me to this land, it was like the plan of a god, or like a dream.</p><p>Amunenshi was pleased. He gave me his eldest daughter in marriage. He let me choose from his lands the finest along the border with another region. It was a land called <span class="gloss" data-gloss="araru">Araru</span>.</p>`,
    question: {
      ...
      factPt: '<span class="gloss" data-gloss="araru">Araru</span> é descrita como "sem igual na terra", havia mais vinho do que água, mel abundante e gado sem limite. O texto usa essa abundância para mostrar que Sinué prosperou, mas que nada se compara ao Egito.',
      factEn: '<span class="gloss" data-gloss="araru">Araru</span> is described as "without equal on earth", there was more wine than water, plentiful honey, and cattle without limit. The text uses this abundance to show that Sinuhe prospered, but that nothing compares to Egypt.'
    }
  },
  {
    ...
    notePt: 'O elogio de <span class="gloss" data-gloss="sesostris">Sesostris I</span> por Sinué é um dos mais extensos da literatura egípcia e usa metáforas marciais brilhantes. A comparação com <span class="gloss" data-gloss="montu">Montu</span> e Sekhmet era o mais alto elogio guerreiro possível. Filólogos modernos debatem se o elogio é propaganda política ou expressão genuína de lealdade.',
    noteEn: 'The praise of <span class="gloss" data-gloss="sesostris">Sesostris I</span> by Sinuhe is one of the most extensive in Egyptian literature and uses brilliant martial metaphors. The comparison with <span class="gloss" data-gloss="montu">Montu</span> and Sekhmet was the highest possible warrior praise. Modern philologists debate whether the eulogy is political propaganda or a genuine expression of loyalty.',
    storyPt: `<p class="dropcap"><span class="gloss" data-gloss="amunenshi">Amunenshi</span> perguntou-me: "Como estará aquela terra sem ele, aquele deus excelente? Como é o medo que ele inspira, como Sekhmet em um ano de pestilência?"</p><p>Respondi-lhe: "Seu filho já entrou no palácio e assumiu a herança de seu pai. Ele é um deus sem igual, nenhum outro surgiu diante dele. Ele é um herói que age com seu próprio braço, um campeão sem igual. Quando o vemos atacar, dobra chifres e enfraquece mãos. Seus inimigos não conseguem formar tropas. Ele é vingativo, esmaga cabeças, ninguém pode ficar perto dele."</p><p>"Sua cidade o ama mais do que a si mesma, e se alegra com ele mais do que com seu próprio deus. Homens e mulheres celebram ao vê-lo passar. Ele é um rei que conquistou ainda no ovo, sua mente estava voltada para isso desde que nasceu. Quão alegre é a terra que ele governa! Ele estenderá as fronteiras."</p><p><span class="gloss" data-gloss="amunenshi">Amunenshi</span> disse-me então: "O Egito é feliz, pois conhece a sua capacidade. Você ficará aqui comigo, o que farei por você será bom."</p>`,
    storyEn: `<p class="dropcap"><span class="gloss" data-gloss="amunenshi">Amunenshi</span> asked me: "How will that land be without him, that excellent god? How is the fear he inspires, like Sekhmet in a year of pestilence?"</p><p>I answered him: "His son has already entered the palace and assumed his father's inheritance. He is a god without equal, no other arose before him. He is a hero who acts with his own arm, a champion without equal. When he is seen attacking, he bends down horns and weakens hands. His enemies cannot marshal troops. He is vengeful, he smashes heads, no one can stand near him."</p><p>"His city loves him more than itself and rejoices in him more than in its own god. Men and women celebrate at the sight of him. He is a king who conquered while still in the egg, his mind was set to it since he was born. How joyful is the land that he rules! He will extend the borders."</p><p><span class="gloss" data-gloss="amunenshi">Amunenshi</span> then said to me: "Egypt is happy, for it knows his ability. You will stay here with me, what I shall do for you is good."</p>`,
    question: {
      ...
      factPt: 'Sekhmet era a deusa leoa da guerra e da pestilência, seu nome significa "a poderosa". Comparar o rei a Sekhmet era o mais alto elogio marcial possível no <span class="gloss" data-gloss="reino-medio">Reino Médio</span>.',
      factEn: 'Sekhmet was the lioness goddess of war and pestilence, her name means "the powerful one". Comparing the king to Sekhmet was the highest possible martial praise in the <span class="gloss" data-gloss="reino-medio">Middle Kingdom</span>.'
    }
  },
  {
  ...
  },
  {
    ...
    storyPt: `<p class="dropcap">Veio de <span class="gloss" data-gloss="retjenu">Retjenu</span> um homem forte, um herói sem igual que havia destruído toda a região. Declarou que lutaria comigo, querendo tomar meu gado. <span class="gloss" data-gloss="amunenshi">Amunenshi</span> consultou-me. Aceitei o desafio.</p><p>À noite, tendi meu arco, disparei minhas flechas, afiei meu punhal e polí minhas armas. Quando o dia amanheceu, <span class="gloss" data-gloss="retjenu">Retjenu</span> havia se reunido. As tribos se juntaram, os vizinhos se agruparam, todos aguardavam a batalha. Todo coração ardia por mim; mulheres tagarelavam, todos me queriam bem.</p><p>O herói veio em minha direção. Aguardei posicionado perto dele. Deixei suas flechas passarem por mim. Quando ele se aproximou, disparei-o, minha flecha ficou cravada em seu pescoço. Ele gritou e caiu de bruços. Com o seu próprio machado, abati-o. Dei louvor a <span class="gloss" data-gloss="montu">Montu</span>. Tornei-me grande. Engrandeci-me em bens. Meu rebanho multiplicou-se.</p>`,
    storyEn: `<p class="dropcap">There came from <span class="gloss" data-gloss="retjenu">Retjenu</span> a strong man, a hero without equal who had entirely devastated the region. He declared he would fight me, intending to seize my cattle. <span class="gloss" data-gloss="amunenshi">Amunenshi</span> consulted with me. I accepted the challenge.</p><p>At night, I strung my bow, shot my arrows, sharpened my dagger, and polished my weapons. When the day dawned, <span class="gloss" data-gloss="retjenu">Retjenu</span> had assembled. The tribes gathered, the neighbors came together, all awaiting the battle. Every heart burned for me; women were chattering, all wished me well.</p><p>The hero came toward me. I waited, positioned close to him. I let his arrows pass me by. When he approached, I shot him, my arrow stuck in his neck. He cried out and fell on his face. With his own axe I struck him down. I gave praise to <span class="gloss" data-gloss="montu">Montu</span>. I became great. I grew rich in goods. My herds multiplied.</p>`,
    question: {
  ...
  },
  {
    ...
    notePt: 'A carta real (<i>wD-nsw</i>) prometia a Sinué um enterro com <strong>pirâmide de pedra</strong>, imagem revestida de ouro e máscara de <span class="gloss" data-gloss="lapis-lazuli">lápis-lazúli</span>, privilégios reservados à realeza. A construção de uma pirâmide para um servo, por ordem do próprio faraó, é o símbolo máximo da reintegração de Sinué à ordem do mundo.',
    noteEn: 'The royal decree (<i>wD-nsw</i>) promised Sinuhe a burial with a <strong>pyramid of stone</strong>, a gold-sheathed image and a mask of <span class="gloss" data-gloss="lapis-lazuli">lapis lazuli</span>, privileges reserved for royalty. The construction of a pyramid for a servant, by order of the pharaoh himself, is the ultimate symbol of Sinuhe\'s reintegration into the world order.',
    storyPt: `<p class="dropcap"><span class="gloss" data-gloss="sesostris">Sesostris</span> soube da condição em que eu me encontrava e enviou-me uma carta com presentes reais. Ela dizia: "Tuas peregrinações pelas terras foram ao conselho do teu próprio coração. Não insultaste ninguém. Pensa no dia do enterro e no passar à bem-aventurança. Não morrerás em terra estrangeira, asiáticos não te sepultarão."</p><p>Quando a carta foi lida para mim, lancei-me de bruços no chão. Percorri meu acampamento gritando de alegria. Passei um dia em <span class="gloss" data-gloss="araru">Araru</span>, transferindo meus bens aos filhos, e segui para o sul pela Estrada de Hórus.</p><p>No Egito, inclinei minha testa entre as esfinges diante do palácio. O rei disse: "Ele voltou como um asiático criado pelos beduínos." As princesas e a rainha soltaram um grito ao me ver. Mas Sesostris disse: "Não há razão para temer." E então, recebi o que nenhum homem comum havia recebido: uma pirâmide de pedra construída para mim entre as dos filhos do rei, com minha imagem revestida de ouro e saiote de electrum. Foi Sua Majestade quem mandou fazer isso.</p>`,
    storyEn: `<p class="dropcap"><span class="gloss" data-gloss="sesostris">Sesostris</span> learned of my state and sent me a letter with royal gifts. It said: "Your wandering through lands was at the counsel of your own heart. You insulted no one. Think of the day of burial and of passing into blessedness. You will not die in a foreign land, Asiatics will not bury you."</p><p>When the letter was read to me, I threw myself face down on the ground. I went around my encampment crying out for joy. I spent a day in <span class="gloss" data-gloss="araru">Araru</span>, transferring my property to my children, and set out southward by the Road of Horus.</p><p>In Egypt, I touched my forehead to the ground between the sphinxes before the palace. The king said: "He has returned as an Asiatic raised by bedouin." The princesses and the queen let out a cry at the sight of me. But Sesostris said: "There is no reason to fear." And then, I received what no ordinary man had ever received: a pyramid of stone built for me among the king's children's, with my image sheathed in gold and a kilt of electrum. It was His Majesty who ordered this to be done.</p>`,
    question: {
