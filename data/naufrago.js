const I18N = {
  pt: {
    ...
    'tour-s3-title':   'Nota Arqueológica',
    'tour-s3-body':    'Toque aqui para ver o contexto histórico por trás desta parte da história.',
    'tour-s4-title':   'Trilha Sonora',
    'tour-s4-body':    'Liga e desliga a música de fundo. Vale ouvir com fones para mergulhar na cena.',
  },
  en: {
    'brand':           'Musæum',
    'score-label':     'POINTS',
    ...
    'tour-s3-title':   'Archaeological Note',
    'tour-s3-body':    'Tap here to see the historical context behind this part of the story.',
    'tour-s4-title':   'Soundtrack',
    'tour-s4-body':    'Turns the background music on and off. Headphones make the scene more immersive.',
  }
};
