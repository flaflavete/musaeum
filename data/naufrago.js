...
const CHAPTERS = [
  ...
  },
  {
    ...
    notePt: 'Navios para o mar existiam de verdade. Um funcionário chamado Ameny registrou, no reinado de Sesostris I, que esteve "na margem do <span class="gloss" data-gloss="grande-verde">Grande Verde</span>" construindo navios para a viagem a <span class="gloss" data-gloss="punt">Punt</span>; é o mesmo nome que o conto usa para o mar. E no porto de Mersa Gawasis, no Mar Vermelho, arqueólogos encontraram âncoras de pedra, madeiras de navio e estelas dessas viagens. Os 120 <span class="gloss" data-gloss="covado">côvados</span> (cerca de 60 metros) são exagero de contador de histórias, mas o estaleiro era real.',
    noteEn: 'Seagoing ships really existed. An official named Ameny recorded, in the reign of Sesostris I, that he was "on the shore of the <span class="gloss" data-gloss="grande-verde">Great Green</span>" building ships for the voyage to <span class="gloss" data-gloss="punt">Punt</span>; it is the same name the tale uses for the sea. And at the harbour of Mersa Gawasis, on the Red Sea, archaeologists found stone anchors, ship timbers, and stelae from these voyages. The 120 <span class="gloss" data-gloss="covado">cubits</span> (about 60 meters) are a storyteller\'s exaggeration, but the shipyard was real.',
  ...
  },
  {
    ...
    notePt: 'No conto, a ilha dá tudo de graça. Na vida real era o contrário: uma inscrição do reinado de Sesostris I lista o que foi preciso levar para alimentar 18.742 pessoas numa expedição às pedreiras de Wadi Hammamat: pão, cerveja, carne, aves, odres de água e até sandálias untadas com <span class="gloss" data-gloss="mirra">mirra</span>. Cada refeição atravessava o deserto nas costas da caravana.',
    noteEn: 'In the tale, the island provides everything for free. In real life it was the opposite: an inscription from the reign of Sesostris I lists what had to be carried to feed 18,742 people on an expedition to the quarries of Wadi Hammamat: bread, beer, meat, fowl, water skins, and even sandals anointed with <span class="gloss" data-gloss="mirra">myrrh</span>. Every meal crossed the desert on the caravan\'s back.',
  ...
  },
  {
    ...
    notePt: 'Ouro e <span class="gloss" data-gloss="lapis-lazuli">lápis-lazúli</span> eram tesouros que os egípcios conheciam de perto. O lápis-lazúli nem existe no Egito: vinha das montanhas do atual Afeganistão, passando de mão em mão por rotas de troca até chegar. Uma estela da época, hoje no Museu Egípcio do Cairo, lista mesas de oferenda e colares desses materiais entre o equipamento dos templos. Descrever a serpente coberta de ouro e lápis-lazúli era vesti-la com o que havia de mais precioso no mundo egípcio.',
    noteEn: 'Gold and <span class="gloss" data-gloss="lapis-lazuli">lapis lazuli</span> were treasures Egyptians knew well. Lapis lazuli does not even occur in Egypt: it came from the mountains of present-day Afghanistan, passing from hand to hand along trade routes. A stela of the period, now in the Egyptian Museum in Cairo, lists offering tables and collars of these materials among temple equipment. Describing the serpent covered in gold and lapis lazuli meant dressing it in the most precious things the Egyptian world knew.',
