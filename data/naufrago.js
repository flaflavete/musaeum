...
const CHAPTERS = [
  ...
  },
  {
    ...
    notePt: 'Ouro e <span class="gloss" data-gloss="lapis-lazuli">lápis-lazúli</span> eram tesouros que os egípcios conheciam de perto. O lápis-lazúli nem existe no Egito: vinha das montanhas do atual Afeganistão, passando de mão em mão por rotas de troca até chegar. Num esconderijo sob o templo de Montu, em Tod, arqueólogos acharam quatro cofres de bronze com o nome de Amenemhat II cheios de lápis-lazúli em bruto, em contas e em selos, um tesouro hoje dividido entre o Museu Egípcio do Cairo e o Louvre. Descrever a serpente coberta de ouro e lápis-lazúli era vesti-la com o que havia de mais precioso.',
    noteEn: 'Gold and <span class="gloss" data-gloss="lapis-lazuli">lapis lazuli</span> were treasures Egyptians knew well. Lapis lazuli does not even occur in Egypt: it came from the mountains of present-day Afghanistan, passing from hand to hand along trade routes. In a cache beneath the temple of Montu at Tod, archaeologists found four bronze chests bearing the name of Amenemhat II, filled with lapis lazuli raw, in beads, and in seals, a treasure now divided between the Egyptian Museum in Cairo and the Louvre. Describing the serpent covered in gold and lapis lazuli meant dressing it in the most precious things.',
  ...
  },
  {
    ...
    notePt: 'O conto termina voltando ao mundo de quem o escreveu. A fala do marinheiro tem o formato das autobiografias que funcionários egípcios mandavam gravar em seus túmulos e estelas: a missão, o perigo vencido, a recompensa do rei. E no papiro que guardou a história, a última linha é a assinatura do copista: o escriba "de dedos hábeis", Amenaa, filho de Ameny, garantindo que copiou tudo "do início ao fim".',
    noteEn: 'The tale ends by returning to the world of the people who wrote it. The sailor\'s speech has the shape of the autobiographies Egyptian officials had carved in their tombs and stelae: the mission, the danger overcome, the king\'s reward. And on the papyrus that preserved the story, the last line is the copyist\'s signature: the scribe "of skilled fingers", Amenaa, son of Ameny, assuring that he copied everything "from beginning to end".',
