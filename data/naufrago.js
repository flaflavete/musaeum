...
const CHAPTERS = [
  ...
  },
  {
    ...
    notePt: 'No conto, a ilha dá tudo de graça. Na vida real era o contrário: uma inscrição do reinado de Sesostris I lista o que foi preciso levar para alimentar milhares de pessoas numa expedição às pedreiras de Wadi Hammamat: pão, cerveja, carne, aves e odres de água. Cada refeição atravessava o deserto nas costas da caravana.',
    noteEn: 'In the tale, the island provides everything for free. In real life it was the opposite: an inscription from the reign of Sesostris I lists what had to be carried to feed thousands of people on an expedition to the quarries of Wadi Hammamat: bread, beer, meat, fowl, and water skins. Every meal crossed the desert on the caravan\'s back.',
  ...
  },
  {
    ...
    notePt: 'Ouro e <span class="gloss" data-gloss="lapis-lazuli">lápis-lazúli</span> eram tesouros que os egípcios conheciam de perto. O lápis-lazúli nem existe no Egito: vinha das montanhas do atual Afeganistão, passando de mão em mão por rotas de troca até chegar. Uma estela da época, hoje no Museu Egípcio do Cairo, lista mesas de oferenda e colares desses materiais entre o equipamento dos templos. Descrever a serpente coberta de ouro e lápis-lazúli era vesti-la com o que havia de mais precioso.',
    noteEn: 'Gold and <span class="gloss" data-gloss="lapis-lazuli">lapis lazuli</span> were treasures Egyptians knew well. Lapis lazuli does not even occur in Egypt: it came from the mountains of present-day Afghanistan, passing from hand to hand along trade routes. A stela of the period, now in the Egyptian Museum in Cairo, lists offering tables and collars of these materials among temple equipment. Describing the serpent covered in gold and lapis lazuli meant dressing it in the most precious things.',
